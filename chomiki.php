...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="myNavbar">
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    ?>
                    <li><a href="koszykPOST.php"><i class="fas fa-shopping-cart"></i>Koszyk</a></li>
                </ul>
            </div>
        </div>
    ...
    <div class="container" style="padding:5px">
        ...
        $sql = 'SELECT nazwa, cena, opis FROM produkt WHERE kategoria_id = :didbv ORDER BY producent_id';
        $stid = oci_parse($conn, $sql);
        $didbv = 3;
        oci_bind_by_name($stid, ':didbv', $didbv);
        oci_execute($stid);
        while (($row = oci_fetch_array($stid, OCI_ASSOC)) != false) {
            echo  " <form class='form-horizontal' method='post' action='koszyk.php'><div class='col-md-12 text-centre bg-grey container-fluid prod ' style='margin:10px'><b>".$row['NAZWA'] . "</b><br>\n";
